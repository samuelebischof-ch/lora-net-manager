...
export class GotthardpService {
  ...
  /**
  * @name getGateways
  * @returns the list of gatewy registered to the LoRaServer
  */
  ...
  /**
  * @name addGateway
  * @description adds a gateway with options body to the LoRaServer
  */
  ...
  */
  ...
  /**
  * @name addNetwork
  * @description adds a network from the settings in gotthardp.config.json to the LoRaServer
  */
  addNetwork() {
    const options: any = Object.assign({}, loRaServerOptions);
  ...
  /**
  * @name addProfile
  * @description adds a profile from the settings in gotthardp.config.json to the LoRaServer
  */
  addProfile() {
    const options: any = Object.assign({}, loRaServerOptions);
  ...
  /**
  * @name addHandler
  * @description adds a handler from the settings in gotthardp.config.json to the LoRaServer
  */
  addHandler() {
    const options: any = Object.assign({}, loRaServerOptions);
  ...
  /**
  * @name addConnectors
  * @description adds a connector from the settings in gotthardp.config.json to the LoRaServer
  */
  addConnectors() {
    const options: any = Object.assign({}, loRaServerOptions);
  ...
  * @description returns the list of gatewy registered to the LoRaServer
  */
  ...
  /**
  * @name addDevice
  * @description adds a device from the settings in gotthardp.config.json to the LoRaServer
  */
  addDevice(body) {
    const options: any = Object.assign({}, loRaServerOptions);
    options.uri += 'api/devices';
  ...
  * @name removeDevice
  * @param deveui
  * @description removes the device from the LoRaServer
  */
  ...
  * @name removeNode
  * @param mac
  * @description removes the node (active device) from the LoRaServer
  */
